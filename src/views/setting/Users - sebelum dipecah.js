              ...
              <CCard className="mb-4">
                <CCardBody className="p-4">
                    <div style={{ display: "flex", justifyContent: "space-between", gap: "10px",  alignItems: "center", marginBottom: "10px" }}>
                      ...
                      <div>
                        <input style={{display: isEditing || isOveriding || isViewProfile ? "none" : "block" }} maxLength="32" type="text" placeholder="Filter Username" onChange={handleSearch} />
                      </div>
                    </div>
                    ...
                    <div style={{display: isEditing || isViewProfile ? "block" : "none", marginBottom: "10px" }}>
                      <CRow>
                        <CCol xs={12}>
                          <CCard className="mb-4">
                            <CCardBody>
                                <CForm className="row g-3">
                                  ...
                                  <CCol md={4} style={{display: isAdding ? "block" : "none" }}>
                                    ...
                                    <CFormInput type="text" id="inputEmail" disabled={isViewProfile ? "disabled" : ""}
                                  ...
                                  <CCol md={6} >
                                    ...
                                    <input type="date" className="form-control" id="dateOfBirth"
                                       disabled={isViewProfile ? "disabled" : ""}
                                  ...
                                  <CCol md={6}>
                                    ...
                                    <CFormInput type="text" id="inputFirstName" disabled={isViewProfile ? "disabled" : ""}
                    ...
                    <div style={{display: isEditing || isOveriding || isViewProfile ? "none" : "block"}}>
