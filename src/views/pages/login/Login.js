            ...
            <CCardGroup>
              ...
              <CCard className="text-white bg-primary py-5" style={{ width: '44%' }}>
                <CCardBody className="text-center">
                  <div>
                    <p>
                      Login dengan username : [Administrator] dan password : [Password123] untuk melihat daftar user yang sudah ada
                      atau membuat user baru. Atau daftar untuk membuat user baru
                    </p>
                    <p>Database backend digunakan untuk kebutuhan belajar, mohon kebijakannya dalam
                      mencoba dan memasukan data.
                    </p>
                    <Link to="/register">
